...
class TranslationManager:
    ...
    _translations: Dict[str, Dict[str, str]] = {
        "de": {
            ...
            "zone_editor_mode_motion": "nur Bewegung ignorieren",
            ...
            "zone_editor_hint": "<kbd>Linke Maustaste</kbd> ziehen = malen &nbsp;·&nbsp; <kbd>Rechte Maustaste</kbd> ziehen = radieren. Markierte Bereiche werden bei der Bewegungserkennung ignoriert.",
        ...
        "en": {
            ...
            "zone_editor_mode_motion": "ignore motion only",
            ...
            "zone_editor_hint": "<kbd>Left mouse button</kbd> drag = paint &nbsp;·&nbsp; <kbd>Right mouse button</kbd> drag = erase. Marked areas are ignored by motion detection.",
            ...
            "zone_editor_saved": "Saved — takes effect immediately in the running watcher.",
            "zone_editor_saved_off": "Saved, but INACTIVE (\"Mask active\" is off) — counter-check.",
