...
class TranslationManager:
    ...
    _translations: Dict[str, Dict[str, str]] = {
        "de": {
            ...
            "vision_preview_teleprompter_idle": "Watch-Mode nicht aktiv — VLM-Beobachtung pausiert.",
        ...
        "en": {
            ...
            "vision_preview_teleprompter_idle": "Watch mode inactive — VLM observation paused.",
            "vision_preview_teleprompter_mode_label": "Teleprompter",
