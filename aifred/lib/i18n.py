...
class TranslationManager:
    ...
    _translations: Dict[str, Dict[str, str]] = {
        "de": {
            ...
            "zone_editor_mode_roi": "Region of Interest (nur hier)",
            ...
            "zone_editor_hint": "<kbd>Linke Maustaste</kbd> malt den gewählten Typ, <kbd>rechte</kbd> radiert. &nbsp; Rot = Bewegung ignorieren &nbsp;·&nbsp; Schwarz = schwärzen (DSGVO) &nbsp;·&nbsp; Grün = nur hier analysieren (ROI).",
        ...
        "en": {
            ...
            "zone_editor_mode_roi": "region of interest (only here)",
            ...
            "zone_editor_hint": "<kbd>Left mouse button</kbd> paints the selected type, <kbd>right</kbd> erases. &nbsp; Red = ignore motion &nbsp;·&nbsp; Black = blackout (GDPR) &nbsp;·&nbsp; Green = analyse only here (ROI).",
